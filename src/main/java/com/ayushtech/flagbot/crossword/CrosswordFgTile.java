...
public enum CrosswordFgTile {
    BLACK(Emoji.fromFormatted("<:bke:1537122116200046774>"), "Black"),
    WHITE(Emoji.fromFormatted("<:wte:1537122099590594701>"), "White"),
    ORANGE(Emoji.fromFormatted("<:oge:1537102655418007593>"), "Orange"),
    BLUE(Emoji.fromFormatted("<:ble:1537102646975004692>"), "Blue"),
    RED(Emoji.fromFormatted("<:rde:1537102660971266048>"), "Red"),
    BROWN(Emoji.fromFormatted("<:bwe:1537102649512562699>"), "Brown"),
    PURPLE(Emoji.fromFormatted("<:ple:1537102657997512844>"), "Purple"),
    GREEN(Emoji.fromFormatted("<:gne:1537102653392289802>"), "Green"),
    YELLOW(Emoji.fromFormatted("<:yle:1537102663550771270>"), "Yellow");
